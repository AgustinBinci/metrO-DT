        ...
        <div id="create-usuario" class="content scaffold-create" role="main">
		    ...
		    <div class="container">
				...
				<div class="form-group">
					...
					<div class="has-success has-feedback">
						<input class="form-control" type="email" maxlength="50" name="email" pattern="^\w+[a-z,A-Z,0-9,.,-,_]*@\w+[a-z,A-Z,0-9,.,-,_]*([.])\w.*$" id="emailInput" placeholder="Email" value="${email}" required>
						<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
						<span class="sr-only"></span>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label" for="contraseniaRepetidaInput">Repetir contraseña</label>
					<div class="has-success has-feedback">
						<input class="form-control" type="password" maxlength="50" name="contraseniaRepetida" id="contraseniaRepetidaInput" placeholder="Misma contraseña" required>
						<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
						<span class="sr-only"></span>
					</div>
				</div>
				...
				<input type="submit" id="crearUsuario" class="btn btn-default" value="${message(code: 'default.create')}">
			    </g:form>
		    </div>
        </div>
    </body>
